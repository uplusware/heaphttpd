...
WebCGI::WebCGI() {
  ...
  m_meta_var.insert(
      map<string, string>::value_type("GATEWAY_INTERFA", "CGI/1.1"));
  ...
  m_meta_var.insert(
      map<string, string>::value_type("SERVER_PROTOCOL", "HTTP/1.1"));
  m_meta_var.insert(
      map<string, string>::value_type("SERVER_SOFTWARE", VERSION_STRING));
}
