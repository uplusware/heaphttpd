...
void http_request::set_cookie_var(const char* key,
                                  const char* val,
                                  int max_age,
                                  const char* expires,
                                  const char* path,
                                  ...
                                  BOOL secure,
                                  BOOL httponly) {
  m_session->SetCookie(key, val, max_age, expires, path, domain, secure,
                       httponly);
}
...
int http_request::get_multipart_formdata(const char* content_name,
                                         ...
                                         int& content_vallen) {
  return m_session->parse_multipart_formdata(content_name, content_filename,
                                             content_filetype, content_valbuf,
                                             content_vallen);
}
