...
CHttpResponseHdr::CHttpResponseHdr() {
  ...
  m_mapHeader.insert(
      map<string, string>::value_type("Access-Control-Allow-Origin", ""));
  ...
  m_mapHeader.insert(
      map<string, string>::value_type("Content-Disposition", ""));
  ...
  m_mapHeader.insert(
      map<string, string>::value_type("Strict-Transport-Security", ""));
...
void CHttpResponseHdr::SetStatusCode(Http_StatsCode StatusCode) {
  ...
  m_strDefaultHTML += "<p><i>This default page is generated by " VERSION_STRING
                      ".</i></p></BODY></HTML>";
}
