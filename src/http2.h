...
enum http2_msg_type { http2_msg_quit = 0, http2_msg_data };
...
class CHttp2 : public IHttp {
 public:
  ...
  int ProtParse(const HTTP2_Frame& frame_hdr,
                char* payload,
                uint_32 payload_len,
                uint_32 stream_ind);
  int ProtRecv();
  ...
  int TransHttp1SendHttp2Header(uint_32 stream_ind,
                                const char* buf,
                                int len,
                                uint_8 frame_type = HTTP2_FRAME_TYPE_HEADERS,
                                uint_32 promised_stream_ind = 0);
  int TransHttp1SendHttp2Content(uint_32 stream_ind,
                                 const char* buf,
                                 uint_32 len);

  int SendHttp2EmptyContent(uint_32 stream_ind,
                            uint_8 flags = (HTTP2_FRAME_FLAG_END_STREAM |
