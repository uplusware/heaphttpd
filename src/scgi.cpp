...
scgi::scgi(const char* ipaddr, unsigned short port) : cgi_base(ipaddr, port) {
  m_is_connected = false;
}

scgi::scgi(const char* sock_file) : cgi_base(sock_file) {}
...
int scgi::SendParamsAndData(map<string, string>& params_map,
                            const char* postdata,
