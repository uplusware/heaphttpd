...
Session::~Session()
{
    ...
    for(iter_instance1 = m_fastcgi_instances.begin(); iter_instance1 != m_fastcgi_instances.end(); iter_instance1++)
    {
        delete iter_instance1->second;
    }
    
    map<string, scgi*>::iterator iter_instance2;
    for(iter_instance2 = m_scgi_instances.begin(); iter_instance2 != m_scgi_instances.end(); iter_instance2++)
    {
