...
void* reverse_delivery(const char* name,
  ...
  Use | to append HA host(support 3 hosts). Eg.:
  http://domain_name_or_ip1|domain_name_or_ip2|domain_name_or_ip3
  */
  ...
  *skip = 0;  // zero is not to skip the follow-up reverse extension, non-zero
              // is to skip them.
