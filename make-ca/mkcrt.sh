...
openssl req -new -key private/cakey.pem -out private/ca.csr -subj "/C=CN/ST=BJ/L=BJ/O=www/OU=www/CN=uplusware"
...
openssl req -new -key private/server-key.pem -out private/server.csr -subj "/C=CN/ST=BJ/L=BJ/O=www/OU=www/CN=uplusware"
...
openssl req -new -key private/client-key.pem -out private/client.csr -subj "/C=CN/ST=BJ/L=BJ/O=www/OU=www/CN=uplusware"
